...
$output .= "<div class='wpmf-gallery'><div id='$selector' data-id='$selector' class='gallery gallery-link-".$link." flexslider carousel wpmfflexslider' data-columns='$columns'>";
...
foreach ($attachments as $id => $attachment) {
    ...
    $output .= "<li class='gallery-item item gallery-item-position-" . $pos . " gallery-item-attachment-" . $id . "' style='position: relative;height:".max($height_array)."px'>";
