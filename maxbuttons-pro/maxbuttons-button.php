...
if ($_POST) {
	...
	if ($_GET['id'] == '') {
		...
		$data_format = array('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s');
		...
		<form id="new-button-form" method="post">
			...
			<div class="option-container">
				...
				<div class="inside">
					...
					<div class="option">
						...
						<div class="note"><?php _e('The link when the button is clicked.', 'maxbuttons-pro') ?></div>
						<div class="clear"></div>
						<div class="input">
			...
			<div class="option-container">
				...
				<div class="inside">
					...
					<div class="option-design">
						<div class="label">&nbsp;</div>
						<div class="input"><a class="button" href="#" onclick="window.open('<?php echo MAXBUTTONS_PRO_PLUGIN_URL ?>/maxbuttons-button-css.php?id=<?php echo $_GET['id'] ?>', 'ButtonCSS', 'width=800, height=650, scrollbars=1'); return false;"><?php _e('View CSS', 'maxbuttons-pro') ?></a></div>
						<div class="clear"></div>
					</div>
				</div>
			</div>
