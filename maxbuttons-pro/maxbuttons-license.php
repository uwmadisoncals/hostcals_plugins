			...
			<form id="license_form">
				<?php if ($license_activated == 'yes') { ?>
					<table>
						<tr>
							<td>
								<h3 class="license-label"><?php _e('License Key:', 'maxbuttons-pro') ?></h3>
							</td>
							<td>
								<h3 class="license-data"><?php echo get_option(MAXBUTTONS_PRO_LICENSE_KEY) ?></h3>
							</td>
						</tr>
					</table>
				<?php } else { ?>				
					<div id="activation_progress" class="alert alert-info" style="display: none;">
						<table>
							<tr>
								...
								<td valign="middle">
									<h3><?php _e('Your license key is being activated, please wait...', 'maxbuttons-pro') ?></h3>
								</td>
							</tr>
						</table>
					</div>
					...
					<div id="activation_success" class="alert alert-success" style="display: none;">
						<h3><?php _e('Your license key has been activated. Enjoy using MaxButtons Pro.', 'maxbuttons-pro') ?></h3>
					</div>
					
					<div id="activation_error" class="alert alert-error" style="display: none;">
						<h3><?php printf(__('There was an error activating your license key. Please try again or %scontact us%s so we can investigate the issue.', 'maxbuttons-pro'), '<a href="http://maxbuttons.com/contact/" target="_blank">', '</a>') ?></h3>
					</div>
					
					<h3><?php _e('MaxButtons Pro has not been activated. Activation is required to receive plugin updates and support.', 'maxbuttons-pro') ?></h3>
					<h3><?php _e('Please enter a valid license key:', 'maxbuttons-pro') ?></h3>
