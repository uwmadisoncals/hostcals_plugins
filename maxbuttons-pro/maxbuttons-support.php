<?php
$plugin_version = get_option(MAXBUTTONS_PRO_VERSION_KEY);
$theme = wp_get_theme();
...
<div id="maxbuttons">
	<div class="wrap">
		...
		<div class="main">
			...
			<h3><?php printf(__('All support is handled through the %sSupport Forums%s.', 'maxbuttons-pro'), '<a href="http://maxbuttons.com/forums" target="_blank">', '</a>') ?></h3>
			
			<h3><?php _e('You may be asked to provide the information below to help troubleshoot your issue.', 'maxbuttons-pro') ?></h3>

			<textarea class="system-info" readonly="readonly" wrap="off">
----- Begin System Info -----

<?php echo mbpro_system_label('MaxButtons Pro Version:', $plugin_version, 2) ?>
