jQuery(function () {
  jQuery('.moreInfo').each(function () {
	...
	if( jQuery('#wpts_options_autostep').is(":checked") ) 
			jQuery('.wpts_options_time').fadeIn(900);
	else 
		jQuery('.wpts_options_time').fadeOut(400);
	jQuery('#wpts_options_autostep').change(function(){
		if(this.checked) jQuery('.wpts_options_time').fadeIn(900);
		else jQuery('.wpts_options_time').fadeOut(400);
	});
